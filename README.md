...
![ZarCommerce Logo](./frontend/main-site/public/logo.png)
...
1. **Backend (`/backend`)**: Java Spring Boot kullanılarak geliştirilmiş mikroservisler (`user-service`, `product-service`, `cart-service`, `order-service`, `payment-service`) ve API Gateway.
2. **Frontend (`/frontend`)**: 
